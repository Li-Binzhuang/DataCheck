-- drop table hello_da.dws_minloan_feature_v2_part1_di_zlf_v2;

-- create table hello_da.dws_minloan_feature_v2_part1_di_zlf_v2
-- (
-- cust_no   string,
-- use_credit_apply_id   string,
-- use_create_time   string,
-- use_credit_apply_date   string,
-- local_olduser_order_info_firstloannowgapdays_v2 bigint,
-- local_olduser_order_info_registernowgapdays_v2 bigint,
-- local_olduser_order_info_recent1order_currentorder_createsecondgap_v2   bigint,
-- local_olduser_order_info_recent1order_currentorder_createdaygap_v2   int,
-- local_olduser_order_info_recent1order_currentorder_periodgap_v2   double,
-- local_olduser_order_info_recent1order_currentorder_amountratio_v2   decimal(38,6),
-- local_olduser_order_info_recent1order_applyhour_v2   bigint,
-- local_olduser_order_info_currentorder_applyhour_v2   bigint,
-- local_olduser_order_info_recent1order_currentorder_applyhourgap_v2   bigint,
-- local_olduser_order_info_recent1order_night_v2   int,
-- local_olduser_order_info_recent1order_morning_v2   int,
-- local_olduser_order_info_recent1order_noon_v2   int,
-- local_olduser_order_info_recent1order_afternoon_v2   int,
-- local_olduser_order_info_recent1order_evening_v2   int,
-- local_olduser_order_info_recent1order_maxoverduedays_v2   int,
-- local_olduser_order_info_recent1order_minoverduedays_v2   int,
-- local_olduser_order_info_recent1order_sumoverduedays_v2   bigint,
-- local_olduser_order_info_recent1order_sumprepaydays_v2   bigint,
-- local_olduser_order_info_recent1order_maxprepaydays_v2   int,
-- local_olduser_order_info_recent1order_minprepaydays_v2   int,
-- local_olduser_order_info_recent1order_countidoverduedays_v2   bigint,
-- local_olduser_order_info_recent1order_countidprepaydays_v2   bigint,
-- local_olduser_order_info_recent1order_payperiods_v2   bigint,
-- local_olduser_order_info_recent1ordercurrentday_payperiods_v2   bigint,
-- local_olduser_order_info_recent1order_loanamount_v2   decimal(32,8),
-- local_olduser_order_info_recent1order_repayperiods_v2   double,
-- local_olduser_order_info_recent1order_period1overdue_v2   int,
-- local_olduser_order_info_recent1order_period1overduedays_v2   int,
-- local_olduser_order_info_recent1order_period2overdue_v2   int,
-- local_olduser_order_info_recent1order_period2overduedays_v2   int,
-- local_olduser_order_info_recent1order_period3overdue_v2   int,
-- local_olduser_order_info_recent1order_period3overduedays_v2   int,
-- local_olduser_order_info_recent1order_period4overdue_v2   int,
-- local_olduser_order_info_recent1order_period4overduedays_v2   int,
-- local_olduser_order_info_recent2order_loanhouravg_v2   double,
-- local_olduser_order_info_recent2ordercurrentorder_loanhourgapavg_v2   double,
-- local_olduser_order_info_recent2order_nightcnt_v2   bigint,
-- local_olduser_order_info_recent2order_morning_v2   bigint,
-- local_olduser_order_info_recent2order_noon_v2   bigint,
-- local_olduser_order_info_recent2order_afternoon_v2   bigint,
-- local_olduser_order_info_recent2order_evening_v2   bigint,
-- local_olduser_order_info_recent2order_maxoverduedays_v2   int,
-- local_olduser_order_info_recent2order_minoverduedays_v2   int,
-- local_olduser_order_info_recent2order_sumoverduedays_v2   bigint,
-- local_olduser_order_info_recent2order_avgoverduedays_v2   double,
-- local_olduser_order_info_recent2order_maxprepaydays_v2   int,
-- local_olduser_order_info_recent2order_minprepaydays_v2   int,
-- local_olduser_order_info_recent2order_sumprepaydays_v2   bigint,
-- local_olduser_order_info_recent2order_avgprepaydays_v2   double,
-- local_olduser_order_info_recent2order_ovedueloannocnt_v2   bigint,
-- local_olduser_order_info_recent2order_ovedueidcnt_v2   bigint,
-- local_olduser_order_info_recent2order_prepayloannocnt_v2   bigint,
-- local_olduser_order_info_recent2order_prepayidcnt_v2   bigint,
-- local_olduser_order_info_recent2order_loandaysuseratio_v2   double,
-- local_olduser_order_info_recent2order_currentloandays_v2   bigint,
-- local_olduser_order_info_recent2order_loanamount_v2   decimal(38,8),
-- local_olduser_order_info_recent2order_period1overdue_v2   int,
-- local_olduser_order_info_recent2order_period1maxoverduedays_v2   int,
-- local_olduser_order_info_recent2order_period2overdue_v2   int,
-- local_olduser_order_info_recent2order_period2maxoverduedays_v2   int,
-- local_olduser_order_info_recent2order_period3overdue_v2   int,
-- local_olduser_order_info_recent2order_period3maxoverduedays_v2   int,
-- local_olduser_order_info_recent2order_period4overdue_v2   int,
-- local_olduser_order_info_recent2order_period4maxoverduedays_v2   int,
-- local_olduser_order_info_recent2order_firstoverduedayrank_v2   int,
-- local_olduser_order_info_recent3order_loanhouravg_v2   double,
-- local_olduser_order_info_recent3ordercurrentorder_loanhourgapavg_v2   double,
-- local_olduser_order_info_recent3order_nightcnt_v2   bigint,
-- local_olduser_order_info_recent3order_morning_v2   bigint,
-- local_olduser_order_info_recent3order_noon_v2   bigint,
-- local_olduser_order_info_recent3order_afternoon_v2   bigint,
-- local_olduser_order_info_recent3order_evening_v2   bigint,
-- local_olduser_order_info_recent3order_maxoverduedays_v2   int,
-- local_olduser_order_info_recent3order_minoverduedays_v2   int,
-- local_olduser_order_info_recent3order_sumoverduedays_v2   bigint,
-- local_olduser_order_info_recent3order_avgoverduedays_v2   double,
-- local_olduser_order_info_recent3order_maxprepaydays_v2   int,
-- local_olduser_order_info_recent3order_minprepaydays_v2   int,
-- local_olduser_order_info_recent3order_sumprepaydays_v2   bigint,
-- local_olduser_order_info_recent3order_avgprepaydays_v2   double,
-- local_olduser_order_info_recent3order_ovedueloannocnt_v2   bigint,
-- local_olduser_order_info_recent3order_ovedueidcnt_v2   bigint,
-- local_olduser_order_info_recent3order_prepayloannocnt_v2   bigint,
-- local_olduser_order_info_recent3order_prepayidcnt_v2   bigint,
-- local_olduser_order_info_recent3order_loandaysuseratio_v2   double,
-- local_olduser_order_info_recent3order_currentloandays_v2   bigint,
-- local_olduser_order_info_recent3order_loanamount_v2   decimal(38,8),
-- local_olduser_order_info_recent3order_period1overdue_v2   int,
-- local_olduser_order_info_recent3order_period1maxoverduedays_v2   int,
-- local_olduser_order_info_recent3order_period2overdue_v2   int,
-- local_olduser_order_info_recent3order_period2maxoverduedays_v2   int,
-- local_olduser_order_info_recent3order_period3overdue_v2   int,
-- local_olduser_order_info_recent3order_period3maxoverduedays_v2   int,
-- local_olduser_order_info_recent3order_period4overdue_v2   int,
-- local_olduser_order_info_recent3order_period4maxoverduedays_v2   int,
-- local_olduser_order_info_recent3order_firstoverduedayrank_v2   int,
-- local_olduser_order_info_payofforder_maxoverduedays_v2   int,
-- local_olduser_order_info_payofforder_minoverduedays_v2   int,
-- local_olduser_order_info_payofforder_sumoverduedays_v2   bigint,
-- local_olduser_order_info_payofforder_avgoverduedays_v2   double,
-- local_olduser_order_info_payofforder_maxprepaydays_v2   int,
-- local_olduser_order_info_payofforder_minprepaydays_v2   int,
-- local_olduser_order_info_payofforder_sumprepaydays_v2   bigint,
-- local_olduser_order_info_payofforder_avgprepaydays_v2   double,
-- local_olduser_order_info_recent1payofforder_currentorder_createsecondgap_v2   bigint,
-- local_olduser_order_info_recent1payofforder_currentorder_createdaygap_v2   int,
-- local_olduser_order_info_recent1payofforder_currentorder_periodgap_v2   double,
-- local_olduser_order_info_recent1payofforder_currentorder_amountratio_v2   decimal(38,6),
-- local_olduser_order_info_recent1payofforder_applyhour_v2   bigint,
-- local_olduser_order_info_recent1payofforder_currentorder_applyhourgap_v2   bigint,
-- local_olduser_order_info_recent1payofforder_night_v2   int,
-- local_olduser_order_info_recent1payofforder_morning_v2   int,
-- local_olduser_order_info_recent1payofforder_noon_v2   int,
-- local_olduser_order_info_recent1payofforder_afternoon_v2   int,
-- local_olduser_order_info_recent1payofforder_evening_v2   int,
-- local_olduser_order_info_recent1payofforder_maxoverduedays_v2   int,
-- local_olduser_order_info_recent1payofforder_minoverduedays_v2   int,
-- local_olduser_order_info_recent1payofforder_sumoverduedays_v2   bigint,
-- local_olduser_order_info_recent1payofforder_sumprepaydays_v2   bigint,
-- local_olduser_order_info_recent1payofforder_maxprepaydays_v2   int,
-- local_olduser_order_info_recent1payofforder_minprepaydays_v2   int,
-- local_olduser_order_info_recent1payofforder_countidoverduedays_v2   bigint,
-- local_olduser_order_info_recent1payofforder_countidprepaydays_v2   bigint,
-- local_olduser_order_info_recent1payofforder_payperiods_v2   bigint,
-- local_olduser_order_info_recent1payoffordercurrentday_payperiods_v2   bigint,
-- local_olduser_order_info_recent1payofforder_loanamount_v2   decimal(32,8),
-- local_olduser_order_info_recent1payofforder_repayperiods_v2   double,
-- local_olduser_order_info_recent1payofforder_period1overdue_v2   int,
-- local_olduser_order_info_recent1payofforder_period1overduedays_v2   int,
-- local_olduser_order_info_recent1payofforder_period2overdue_v2   int,
-- local_olduser_order_info_recent1payofforder_period2overduedays_v2   int,
-- local_olduser_order_info_recent1payofforder_period3overdue_v2   int,
-- local_olduser_order_info_recent1payofforder_period3overduedays_v2   int,
-- local_olduser_order_info_recent1payofforder_period4overdue_v2   int,
-- local_olduser_order_info_recent1payofforder_period4overduedays_v2   int
-- )comment '贷中特征part1_v'
-- partitioned BY (pt string) stored AS orcfile;
...
select m0.cust_no
	...
	from (
		...
		from hello_prd.dws_trd_credit_apply_use_loan_df
		where pt ='2026-01-06'
		and substr(use_create_time,1,10) ='2026-01-06'
		) as m0
	inner join (
		select m1.cust_no
		      ,m4.id
		      ...
		      ,m4.settled_time
		      ,m4.loan_end_date
		from (select *from hello_prd.ods_mx_aprv_approve_use_credit_apply_df where pt ='2026-01-06' and substr(create_time,1,10) <='2026-01-06' ) as m1
		inner join (select * from hello_prd.ods_mx_ast_asset_loan_apply_df where pt ='2026-01-06' and substr(create_time,1,10) <='2026-01-06') as m2
		on m1.asset_id = m2.seq_no
		inner join (select * from hello_prd.ods_mx_ast_asset_loan_info_df where loan_status<>'4' and pt ='2026-01-06' and substr(create_time,1,10) <='2026-01-06') as m3 --zlf 增加loan_status<>'4'
		on m2.loan_apply_no = m3.loan_apply_no
		inner join (select * from hello_prd.ods_mx_ast_asset_repay_plan_df where repay_plan_status<>'4' and pt ='2026-01-06' and substr(create_time,1,10) <='2026-01-06') as m4 --zlf repay_plan_status<>'4'
...
insert overwrite table hello_da.dws_minloan_feature_v2_part1_di_zlf_v2 partition(pt ='2026-01-06')
select  t1.cust_no
...
left join (
	...
	from hello_prd.ods_mx_ast_asset_loan_info_df
	where loan_status <>'4' and pt ='2026-01-06' --zlf增加状态判断
	and substr(create_time,1,10) <='2026-01-06'
	group by cust_no
) as t2 on t1.cust_no = t2.cust_no
left join (
	---这样写是考虑到申请的用户都是注册用户
	select create_time,cust_no
	from hello_prd.ods_mx_cust_cust_account_info_df
	where pt ='2026-01-06'
